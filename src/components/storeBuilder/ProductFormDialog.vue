...
const styles = tv({
  slots: {
    ...
    box: 'bg-[var(--surface)] rounded-[calc(var(--radius)+4px)] max-sm:rounded-[var(--radius)] w-full max-w-[680px] max-h-[calc(100dvh-1rem)] sm:max-h-[90vh] flex flex-col overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.2)] transition-[background] duration-300',
    ...
    cols: 'grid grid-cols-1 sm:grid-cols-[200px_1fr] gap-4 sm:gap-6',
    ...
    footer: 'flex justify-end items-center gap-2.5 px-4 sm:px-6 py-3 sm:py-4 border-t border-[var(--border-color)] shrink-0 transition-[border-color] duration-300',
